...
public class LocalInformation {
	 ...
	 * @param food the existing food
	 */
	LocalInformation(int gridWidth, int gridHeight,
			HashMap<Direction, Creature> creatures, List<Direction> freeDirections, Creature food) {
